...
import 'package:main_screen/screens/book/widgets/book_widget.dart';
import 'package:main_screen/screens/book/widgets/wrap_item.dart';
import 'package:main_screen/utils/size_utils.dart';
                ...
                Padding(
                  ...
                  child: TextField(
                    ...
                    onChanged: (v) {
                      context
                          .read<BookBloc>()
                          .add(SearchBooksEvent(searchBooks: files, value: v));
                    },
                              ...
                              child: BlocBuilder<BookBloc, BookState>(
                                builder: (context, state) {
                                  ...
                                  return BookItem(
                                    ...
                                    image: fileDataModel.fileUrl,
                                    bookName: fileDataModel.fileName,
                                    onTap: () async {
