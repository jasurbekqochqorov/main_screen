...
class FileManagerService {
  ...
  static Future<BookStatusModel> checkFile(FileDataModel fileDataModel) async {
  ...
  static String isExist(
    ...
    if (pattern.length > 1) {
      ...
      debugPrint('Last${pattern.last}');
      filePath =
      "/storage/emulated/0/Download/$fileName.${pattern.last}";
      debugPrint(filePath);
    }
